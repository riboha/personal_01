				...
				<div class="col-12">
				    <div class="sign__content">
					    <form id = 'frm' name = 'frm' class="sign__form" method='POST' action="./create.do" >
					        <h3 class="faq__title">수상 등록</h3>
							<div class="faq">
							
							    <div class="sign__group" >
                                    <label class="feature__text  sign__input "  
                                            style="background-color: transparent; color: rgba(255,255,255,0.7); font-size: 15px;  margin: 0px ; padding: 10px; display:inline; " > 영화번호 </label>
                                    <input type="text"  id='filmno' name='filmno' class=" sign__input " style = "display:inline;"  placeholder="" >
    							</div>
    							
							    <div class="sign__group" >
                                    <label class="feature__text  sign__input "  
                                            style="background-color: transparent; color: rgba(255,255,255,0.7); font-size: 15px;  margin: 0px ; padding: 10px; display:inline; " > 년도　　 </label>
                                    <input type="text"  id='year' name='year' class=" sign__input " style = "display:inline;"  placeholder="" >
    							</div>
    							
							    <div class="sign__group" >
                                    <label class="feature__text  sign__input "  
                                            style="background-color: transparent; color: rgba(255,255,255,0.7); font-size: 15px;  margin: 0px ; padding: 10px; display:inline; " > 영화제　 </label>
                                    <input type="text"  id='awardname' name='awardname' class=" sign__input " style = "display:inline;"  placeholder="" >
    							</div>
                                    
							    <div class="sign__group" >
                                    <label class="feature__text  sign__input "  
                                            style="background-color: transparent; color: rgba(255,255,255,0.7); font-size: 15px;  margin: 0px ; padding: 10px; display:inline; " > 부문　　 </label>
                                    <input type="text"  id='prize' name='prize' class=" sign__input " style = "display:inline;"  placeholder="" >
							    </div>
