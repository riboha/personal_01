			...
			<div class="row">
				<div class="col-12">
					<div class="section__wrap">
						<!-- section title -->
						<h2 class="section__title">영화 사진 등록</h2>
						<!-- end section title -->
							...
							<div class="faq" style="width: 100%;">
							    ...
							    <div class="sign__group" >
                                    <label class="feature__text  sign__input "  
                                            style="background-color: transparent; color: rgba(255,255,255,0.7); font-size: 12px;  margin: 0px ; padding: 10px; display:inline; " >사진 등록</label>
                                    <input type="file"  id='photonameMF_list' name='photonameMF_list' class=" sign__input " style = "display:inline;  font-size: 12px;  "  multiple="multiple">
    							</div>

    							<%-- <input type='hidden' name='filmno' id='filmno' value='${param.filmno }'> --%>
    							<input type='hidden' name='filmno' id='filmno' value=' 8'>
