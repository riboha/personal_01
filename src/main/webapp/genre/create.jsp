	   ...
	   // $('#btn_create').click(function(){
		...
		$.ajax({
		    ...
		    success : function(rdata) {
		        if (rdata.cnt >= 1) {
			        alert('등록 성공');
			        location.href='${root}/movie/genre/read.do?genreno='+rdata.genreno;
			    } else {
			        alert('등록 실패');
			        location.href='${root}/movie/genre/list.do';
				}
		    },
				...
				<div class="col-12">
				    <div class="sign__content">
					    <form id = 'frm' name = 'frm' class="sign__form" method='POST' action="./create.do" >
					        <h3 class="faq__title">장르 등록</h3>
							<div class="faq">
			                    <div class="sign__group">
			                        <input type="text"  id='genrename' name='genrename' class="sign__input" placeholder="장르 이름">
			                    </div>
								<div class="sign__group">
									<input type="text" id='genreseq' name='genreseq'  class="sign__input" value="1" placeholder="출력 순서">
								</div>
								<div class="sign__group">
