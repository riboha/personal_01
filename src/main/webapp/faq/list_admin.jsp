			...
			<div class="accordion__list">
			      ...
			      <TABLE style = "width:100%; margin: 30px 25px;">
					  ...
					  <c:forEach var="VO" items="${list }">  <!-- refaqt 객체에 접근 -->
                        <c:set var="faqno" value="${VO.faqno}" />
                        
					    <TR class='clickable-row' data-href= "./read.do?faqno=${faqno }">
					      <TD style="text-align: center;">
					           <span style="margin: 0px;">${faqno}</span>
					      </TD>
					      ...
					      <TD style="text-align: center;">
					           <span style="margin: 0px;">${VO.faqtitle}</span>
					      </TD>
					      
					      <TD style="text-align: center;">
					           <span style="margin: 0px;">${VO.faqhit}</span>
					      </TD>
