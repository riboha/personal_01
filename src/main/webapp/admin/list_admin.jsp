			...
			<div class="accordion__list">
			      ...
			      <TABLE style = "width:100%; margin: 30px 25px;">
					  ...
					  <c:forEach var="VO" items="${list }">  <!-- refaqt 객체에 접근 -->
                        <c:set var="adminno" value="${VO.adminno}" />
                        
					    <TR class='clickable-row' data-href= "./read.do?adminno=${adminno }">
					    
					      <TD style="text-align: center;">
					           <span style="margin: 0px;">${adminno}</span>
					      </TD>
					      
					      <TD style="text-align: center;">
					           <span style="margin: 0px;">${VO.adminid}</span>
					      </TD>

					      <TD style="text-align: center;">
					           <span style="margin: 0px;">${VO.admingrade} </span>
					      </TD>
