					    ...
					    <form id = 'frm' name = 'frm' class="sign__form" method='POST' action="./create.do" enctype="multipart/form-data">
							...
							<div class="faq" style="width: 100%;">
							    ...
							    <div class="sign__group" >
                                    ...
                                    <input type="text"  id='noticetitle' name='noticetitle' class=" sign__input " style = "display:inline;  font-size: 12px;  "  >
    							</div>
                                ...
                                <div class="sign__group " >
                                    ...
                                    <textarea id='noticecontent' name='noticecontent'  class="sign__input"  style = "width: 80%; display:inline;" rows="60" cols="60" placeholder=""></textarea>
                                </div>
							    ...
							    <div class="sign__group" >
                                    ...
                                    <input type="text"  id='noticedate' name='noticedate' class=" sign__input " style = "display:inline;  font-size: 12px;  "  >
    							</div>
							    ...
							    <div class="sign__group" >
                                    ...
                                    <input type="number"  id='noticeshow' name='noticeshow' class=" sign__input " style = "display:inline;  font-size: 12px;  "  >
    							</div>
							    ...
							    <div class="sign__group" >
                                    ...
                                    <input type="number"  id='noticeseq' name='noticeseq' class=" sign__input " style = "display:inline;  font-size: 12px;  "  >
    							</div>

							    <div class="sign__group" >
                                    <label class="feature__text  sign__input "  
                                            style="background-color: transparent; color: rgba(255,255,255,0.7); font-size: 12px;  margin: 0px ; padding: 10px; display:inline; " >관리자 번호</label>
                                    <input type="number"  id='adminno' name='adminno' class=" sign__input " style = "display:inline;  font-size: 12px;  "  >
    							</div>
