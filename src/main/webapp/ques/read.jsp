					    ...
					    <form id = 'frm' name = 'frm' class="sign__form" method='POST' action="./create.do" >
							...
							<div class="faq" style="width: 100%;">
							    ...
							    <div class="sign__group" >
                                    ...
                                    <input type="text"  id='questitle' name='questitle' class=" sign__input " style = "display:inline;  font-size: 12px;  " value="${quesVO.questitle }"  readonly="readonly">
    							</div>
							    ...
							    <div class="sign__group" >
                                    ...
                                    <input type="text"  id='qcateno' name='qcateno' class=" sign__input " style = "display:inline;  font-size: 12px;  " value="${quesVO.qcateno }"  readonly="readonly" >
    							</div>
							    ...
							    <div class="sign__group" >
                                    ...
                                    <textarea  class="sign__input "  id='quescontent' name='quescontent'  style ="height: 100px;  font-size: 12px; " readonly="readonly" rows="" cols="">
                                        ${quesVO.quescontent }
                                    </textarea>        
							    ...
							    <div class="sign__group" >
                                    ...
                                    <input type="text"  id='payno' name='payno' class=" sign__input " style = "display:inline;  font-size: 12px;  " value="${quesVO.payno }" >
    							</div>
    							
                                <input type="hidden"  id='memberno' name='memberno'  value="${quesVO.memberno }">
                                <input type="hidden"  id='quesno' name='quesno'  value="${quesVO.quesno }">
