							...
							<div class="faq" style="width: 100%;">
                                ...
                                <div class="sign__group"  id="pw_div" style="display:none;">
                                    <label class="feature__text  sign__input  col-xs-1"  
                                            style="background-color: transparent; color: rgba(255,255,255,0.7); font-size: 12px;  margin: 0px ; padding: 10px; " >비밀번호</label>
                                    <input type="text"  id='pw' name='pw' class=" sign__input " style = " font-size: 12px;  " value="" >
                                </div>
                                
                                <div class="sign__group"  id="pw_div" style="display:none;">
                                    <label class="feature__text  sign__input  col-xs-1"  
                                            style="background-color: transparent; color: rgba(255,255,255,0.7); font-size: 12px;  margin: 0px ; padding: 10px;  " >비번확인</label>
                                    <input type="text"  id='pw_2' name='pw_2' class=" sign__input " style = " font-size: 12px;  " value="" >
                                </div>
							

                                <div class="sign__group"  >
                                    <label class="feature__text  sign__input  col-xs-1"  
                                            style="background-color: transparent; color: rgba(255,255,255,0.7); font-size: 15px;  margin: 0px ; padding: 10px; width:100px;" >아이디</label>
                                ...
                                <div class="sign__group" >
                                    <label class="feature__text  sign__input  col-xs-1"  
                                            style="background-color: transparent; color: rgba(255,255,255,0.7); font-size: 15px;  margin: 0px ; padding: 10px; width:100px;" >닉네임</label>
                                    <input type="text"  id='nick' name='nick' class=" sign__input " style="background-color: transparent; font-size: 15px;" value="${VO.nick }" >
                                </div>
                                
                                <div class="sign__group" >
                                    <label class="feature__text  sign__input  col-xs-1"  
                                            style="background-color: transparent; color: rgba(255,255,255,0.7); font-size: 15px;  margin: 0px ; padding: 10px; width:100px;" >생년월일</label>
                                ...
                                <div class="sign__group" >
                                    <label class="feature__text  sign__input  col-xs-1"  
                                            style="background-color: transparent; color: rgba(255,255,255,0.7); font-size: 15px;  margin: 0px ; padding: 10px; width:100px;" >전화번호</label>
                                    <input type="text"  id='tel' name='tel' class=" sign__input " style="background-color: transparent; font-size: 15px;"  value="${VO.tel }"  >
                                </div>
                                
                                <div class="sign__group" >
                                    <label class="feature__text  sign__input  col-xs-1"  
                                            style="background-color: transparent; color: rgba(255,255,255,0.7); font-size: 15px;  margin: 0px ; padding: 10px; width:100px;" >이메일</label>
                                    <input type="text"  id='email' name='email' class=" sign__input " style="background-color: transparent; font-size: 15px;"  value="${VO.email }"  >
                                </div>
                                
                                <div class="sign__group" >
                                    <label class="feature__text  sign__input  col-xs-1"  
                                            style="background-color: transparent; color: rgba(255,255,255,0.7); font-size: 15px;  margin: 0px ; padding: 10px; width:100px;" >포인트</label>
                                ...
                                <div class="sign__group" id='mempicMF_div' style = "display:none; ">
                                    <label class="feature__text  sign__input col-xs-1"  
                                            style="background-color: transparent; color: rgba(255,255,255,0.7); font-size: 15px;  margin: 0px ; padding: 10px; width:100px;" >프로필</label>
                                    <input type="file"  id='mempicMF' name='mempicMF' class=" sign__input " style="background-color: transparent; font-size: 15px;">
                                </div>
